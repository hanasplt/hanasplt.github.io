...
document.getElementById("upcoming2").addEventListener("click", function() {
 document.getElementById("past-con").style.display = "none";
...
let cancelappoint = document.querySelector('#cancel');
let cancelappoint2 = document.querySelector('#cancel2');
...
cancelappoint.onclick = () => {
confirmBox.classList.add('open');
}
cancelappoint2.onclick = () => {
 confirmBox.classList.add('open');
}
