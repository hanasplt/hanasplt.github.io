    ...
    if (in_array('criteria_read', $admin_rights)) {
        ...
        if ($result->num_rows > 0) {
            ...
            if (in_array('criteria_update', $admin_rights)) {
                echo '
            <button type="button" class="button-cri-edit" id="openEditCriteriaPopup" data-evid="' . $evid . '" data-evname="' . $event . '" style="cursor: pointer;">
            ...
            if (in_array('criteria_delete', $admin_rights)) {
                echo '
            <button type="button" class="button-cri-trash" onclick="deleteCri(' . $evid . ', \'' . $event . '\')" style="cursor: pointer;">
