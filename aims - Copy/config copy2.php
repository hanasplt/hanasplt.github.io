...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_editCriteria
        ...
        BEGIN
            DECLARE actions VARCHAR(255);
            SET actions = CONCAT('Admin Updated the criteria: ', OLD.criteria, ' to ', NEW.criteria);
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_addCriteria
        ...
        BEGIN
            DECLARE actions VARCHAR(255);
            SET actions = CONCAT('Admin Added a criteria: ', NEW.criteria);
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_addScoring
        ...
        BEGIN
            DECLARE actions VARCHAR(255);
            SET actions = CONCAT('Admin Added a scoring: ', NEW.rank, ' in ', NEW.eventCategory);
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_delScore
        ...
        BEGIN
            DECLARE actions VARCHAR(255);
            SET actions = CONCAT('Admin Deleted a scoring in rank: ', OLD.rank, '-', OLD.eventCategory);
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_addCom
        AFTER INSERT ON committee
        FOR EACH ROW
        BEGIN
            DECLARE actions VARCHAR(255);
            SET actions = CONCAT('Admin Added Committee: ', NEW.comId);
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_delCom
        AFTER DELETE ON committee
        FOR EACH ROW
        BEGIN
            DECLARE actions VARCHAR(255);
            SET actions = CONCAT('Admin Deleted a Committee: ', OLD.comId);
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_addJudge
        ...
        BEGIN
            DECLARE actions VARCHAR(255);
            SET actions = CONCAT('Admin Added a Judge: ', NEW.judgeId);
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_delJudge
        ...
        BEGIN
            DECLARE actions VARCHAR(255);
            SET actions = CONCAT('Admin Deleted a Judge: ', OLD.judgeId);
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_addContestant
        ...
        BEGIN
            DECLARE actions VARCHAR(255);
            SET actions = CONCAT('Admin Added a contestant: ', NEW.contId);
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_delContestant
        ...
        BEGIN
            DECLARE actions VARCHAR(255);
            SET actions = CONCAT('Admin Deleted a contestant: ', OLD.contId);
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_addAcc
        ...
        BEGIN
            INSERT INTO adminlogs (date_on, actions) 
            VALUES (NOW(), CONCAT('Admin Added an account: ', NEW.firstName, ' ', NEW.lastName));
        END;";
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_editAcc
        ...
        BEGIN
            INSERT INTO adminlogs (date_on, actions) 
            VALUES (NOW(), CONCAT('Admin Updated the account id: ', NEW.userId));
        END;";
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_delAcc
        ...
        BEGIN
            INSERT INTO adminlogs (date_on, actions) 
            VALUES (NOW(), CONCAT('Admin Deleted the account id: ', OLD.userId));
        END;";
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_addTeam
        ...
        BEGIN
            INSERT INTO adminlogs (date_on, actions) 
            VALUES (NOW(), CONCAT('Admin Added a Team: ', NEW.teamName));
        END;";
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_editTeam
        ...
        BEGIN
            INSERT INTO adminlogs (date_on, actions) 
            VALUES (NOW(), CONCAT('Admin Updated the team ', NEW.teamName));
        END";
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_delTeam
        ...
        BEGIN
            INSERT INTO adminlogs (date_on, actions) 
            VALUES (NOW(), CONCAT('Admin Deleted the team ', OLD.teamName));
        END";
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_addEvent
        ...
        BEGIN
            INSERT INTO adminlogs (date_on, actions) 
            VALUES (NOW(), CONCAT('Admin Added an event ', NEW.eventName));
        END";
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_editEvent
        ...
        BEGIN
            INSERT INTO adminlogs (date_on, actions) 
            VALUES (NOW(), CONCAT('Admin Updated the event ', NEW.eventName));
        END";
...
$sqlT = "CREATE TRIGGER IF NOT EXISTS tr_log_delEvent
        ...
        BEGIN
            INSERT INTO adminlogs (date_on, actions) 
            VALUES (NOW(), CONCAT('Admin Deleted the event ', OLD.eventName));
        END";
