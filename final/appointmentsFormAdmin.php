        ...
        <div class="UpcomingAppointments">
            ...
            <div class="appoint-buttons">
                <form action="confirm_appointment.php" method="post">
                    <input type="hidden" name="appt_id" value="<?php echo htmlspecialchars($appointment['appt_id']); ?>">
                    <input type="hidden" name="appt_first_name" value="<?php echo htmlspecialchars($appointment['appt_first_name']); ?>">
                    <input type="hidden" name="appt_last_name" value="<?php echo htmlspecialchars($appointment['appt_last_name']); ?>">
                    <input type="hidden" name="appt_phone_number" value="<?php echo htmlspecialchars($appointment['appt_phone_number']); ?>">
                    <input type="hidden" name="appt_email" value="<?php echo htmlspecialchars($appointment['appt_email']); ?>">
                    <input type="hidden" name="appt_brand_model" value="<?php echo htmlspecialchars($appointment['appt_brand_model']); ?>">
                    <input type="hidden" name="appt_unit_issue" value="<?php echo htmlspecialchars($appointment['appt_unit_issue']); ?>">
                    <input type="hidden" name="services_rendered" value="Services to be rendered">
                    <input type="hidden" name="services_fee" value="0.0">
                    <input type="hidden" name="services_bill_date" value="<?php echo date('Y-m-d'); ?>">
