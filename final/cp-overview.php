...
$sql = "SELECT prod_id, prod_color FROM inventory WHERE prod_model = ? AND prod_type != 'Accessory'";
$stmt = $conn->prepare($sql);
                ...
                <div class="colors">
                    ...
                    <ul>
                        ...
                        foreach ($colors as $color) {
                            echo '<li><a href="cp-overview.php?prod_id=' . $color['prod_id'] . '">' . htmlspecialchars($color['prod_color']) . '</a></li>';
                        }
                        ?>
                    </ul>
                </div>
